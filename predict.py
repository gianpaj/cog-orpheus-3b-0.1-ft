...
# MODEL_CACHE = "3b-es_it-ft-research_release"
...
class Predictor(BasePredictor):
    ...
    def predict(
        ...
        voice: str = Input(
            ...
            choices=["tara", "dan", "josh", "emma"],
            default="tara",
        ),
        temperature: float = Input(
            description="Temperature for generation", default=0.6, ge=0.1, le=1.5
        ),
        top_p: float = Input(
            description="Top P for nucleus sampling", default=0.95, ge=0.1, le=1.0
        ),
        repetition_penalty: float = Input(
            description="Repetition penalty", default=1.1, ge=1.0, le=2.0
        ),
